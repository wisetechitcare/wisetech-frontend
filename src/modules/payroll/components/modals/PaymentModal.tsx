                                                            ...
                                                            <Col md={4}>
                                                                <DropDownInput showColor
                                                                    ...
                                                                    options={govtDeductions.map(d => {
                                                                        ...
                                                                        return {
                                                                            label: paid
                                                                                ? `${d.label} (${getCurrencySymbol()}${Math.trunc(d.amount).toLocaleString(getCurrencyLocale())}) — ✓ Paid`
                                                                                : `${d.label} (${getCurrencySymbol()}${Math.trunc(d.amount).toLocaleString(getCurrencyLocale())})`,
                                                                            value: d.value,
