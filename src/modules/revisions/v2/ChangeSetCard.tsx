...
export const ChangeSetCard: React.FC<Props> = ({ cs, expanded, onToggle, onCompare, onRestore }) => {
  ...
  const shown = changes; // Always show all changes
  const hiddenCount = 0;
    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
            ...
            <span
              ...
              style={{ fontFamily: FONT.body, fontSize: 11.5, color: C.textMuted, marginLeft: 'auto' }}
            >
        ...
        <i
          ...
          style={{ color: C.textMuted, fontSize: 13, marginTop: 4, flexShrink: 0 }}
          aria-hidden
        />
      </button>
      ...
      <div style={{ padding: '0 16px 12px 66px' }}>
        ...
        {/* Expanded footer: non-repudiation context + compare */}
        {expanded && (
          <div
            style={{
              display: 'flex',
          ...
          >
            ...
            {cs.rowHash && (
              <span
                ...
                style={{ fontFamily: FONT.body, fontSize: 10.5, color: C.textMuted, display: 'inline-flex', alignItems: 'center', gap: 4 }}
              >
            ...
            <div style={{ marginLeft: 'auto', display: 'flex', gap: 8 }}>
              {onRestore && (
                <button
                  type="button"
                  onClick={() => onRestore(cs.revisionNumber)}
                  style={{
                    background: 'transparent',
                    color: C.textSecondary,
                    border: `1px solid ${C.border}`,
                  ...
                  title="Restore the record to this version"
                >
