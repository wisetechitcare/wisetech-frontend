...
const MyEmployeeTimeSheetPage = ({ fromAdmin }: { fromAdmin: boolean }) => {
    // Write-gated: read-only viewers get the timesheet but not the log-time affordance.
    const canCreate = canDo("timesheets.employees", "create");
    ...
    // console.log("dateSettingsEnabled", dateSettingsEnabled);
    ...
    return (
        ...
        <div className='px-8 py-6'>
            ...
            <MyEmployeeTimeSheetToggle
                dateSettingsEnabled={dateSettingsEnabled}
                fromAdmin={true}
            />

            {/* <MyEmployeesTimeSheetPorject startDate={startDate} endDate={endDate} /> */}
            <NewTimeLogForm show={showModal} onClose={handleCloseTimeSheet} />
    </div>
    )
}

export default MyEmployeeTimeSheetPage