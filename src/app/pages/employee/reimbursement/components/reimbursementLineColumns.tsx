    ...
    },
    {
        ...
        Cell: ({ row }: any) => (
            <span className="d-inline-flex align-items-center gap-2">
                <span className="text-dark fw-bold fs-7">{getCurrencySymbol()}{fmtAmount(row.original.amount)}</span>
        ...
        Footer: () =>
            detailTotal === undefined
                ? null
                : <span style={{ fontWeight: 800, color: '#0f172a' }}>{getCurrencySymbol()}{fmtAmount(detailTotal)}</span>,
    },
    {
