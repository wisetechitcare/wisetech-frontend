...
function DocumentPreviewModal({ url, onClose }: DocumentPreviewModalProps) {
  // Detect file type from URL (strip query-strings first)
  ...
  const modalContent = (
    /*
     * Backdrop — rendered via portal into document.body so it sits at the true
     * top of the stacking context, unaffected by any parent transform / z-index.
     */
    <div
      style={{
        position: "fixed",
    ...
    >
      {/* Modal card — stop propagation so backdrop-click still closes */}
      <div
  ...
  // Portal into document.body — completely outside the app's stacking context
