            ...
            <div>
              ...
              {batch && (
                <div className="text-muted fs-7 mt-1">
                  ...
                  {getCurrencySymbol()}{fmtAmount(detailTotal)} total&nbsp;·&nbsp;Submitted{' '}
  ...
  const columns = useMemo<MRT_ColumnDef<any>[]>(
    () => [
      ...
      }] : []),
      {
        ...
        Footer: () => <span className={`text-dark fw-bold fs-7 ${sensitiveCls}`}>{getCurrencySymbol()}{fmtAmount(rowsTotal)}</span>,
      },
      {
        accessorKey: '_status',
