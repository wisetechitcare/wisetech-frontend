...
export const LeadWorkspace: React.FC<LeadWorkspaceProps> = (props) => {
  ...
  // ── Wizard Pages ───────────────────────────────────────────────────────────
  // Step 8 (Project Execution) is dynamically appended when status.isReceivedTrigger
  ...
  const isReceivedStatus = React.useMemo(() => {
    ...
    return !!(status?.isReceivedTrigger);
  ...
  // ── Project Execution step — only shown when status.isReceivedTrigger ──────
