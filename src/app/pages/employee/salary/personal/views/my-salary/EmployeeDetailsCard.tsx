...
const EmployeeProfileCard = ({ 
    ...
    >
        ...
        >
            ...
            {phone && <ProfileMetaChip icon={<PhoneOutlinedIcon sx={{ fontSize: '14px' }} />} label={phone} />}
                ...
                >
                    ...
                    >
                        <EmployeeProfileCard
                            ...
                            designation={employee?.designations?.role}
                            department={employee?.departments?.name}
                            dateOfJoining={employee?.dateOfJoining ? dayjs(employee?.dateOfJoining?.toString()).format('DD MMM YYYY') : undefined}
