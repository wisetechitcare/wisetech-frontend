...
const Yearly: React.FC<Props> = ({ year, endDate }) => {
  ...
  const [companyTypeYearlyData, setCompanyTypeYearlyData] = useState<any>([]);
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const [
        ...
        getProjectCountByCompanyTypeYearly(startDate, endDateFormatted),
      ]);
  ...
  return (
    <div>
      ...
      {/* Project by company Type Yearly monthly  */}
