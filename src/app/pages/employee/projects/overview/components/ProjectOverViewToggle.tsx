...
import ProjectChartSettingsModal from "./ProjectChartSettingsModal";
...
const ProjectOverViewToggle = ({ toggleItemsActions, fromAdmin = false, dateSettingsEnabled }: MaterialToggleProps) => {
  ...
  return (
    <>
      {/* <div className="d-flex align-items-center justify-content-end">
          <button className="btn btn-primary" onClick={() => handleChooseProjectTypeModal()}>New Project</button>
            <div className="mb-4" style={{fontFamily:'Barlow',fontSize:'24px',fontWeight:'600'}}>Overview</div>
        </div> */}
      <div className="d-flex align-items-center justify-content-between mb-4">
        ...
        <div className="d-flex align-items-center gap-3">
          ...
          {!isLoadingSettings && !projectCanAddFromLeads ? <button className="btn btn-primary" onClick={() => handleChooseProjectTypeModal()}>New Project</button> : ''}
        </div>
      </div>
      ...
      <ChooseProjectTypeModal show={chooseProjectTypeModal} onHide={() => setChooseProjectTypeModal(false)} />
      <ProjectChartSettingsModal show={showChartSettingsModal} onHide={() => setShowChartSettingsModal(false)} />
    </>
  );
};

export default ProjectOverViewToggle;
