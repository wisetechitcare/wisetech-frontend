...
const [weekEnd, setWeekEnd] = useState(() => {
  ...
  if (dateSettingsEnabled) {
    ...
    return (
        <>
            <div className="d-flex flex-md-row flex-column justify-content-md-between align-items-md-center justify-content-start align-items-start gap-3 mb-4">
                <PeriodTabs
                    value={alignment}
                    options={[
