...
import { formatCurrencyDecimal, getCurrencySymbol, getCurrencyLocale } from '@utils/currency';
                            ...
                            <p style={{ fontSize: 12, color: P.inkBody, margin: '0 0 8px' }}>
                                ...
                                <strong>
                                    {sameDayPenalty.penaltyType === 'halfDaySalaryDeduction'
                                        ...
                                        : `${getCurrencySymbol()}${(sameDayPenalty.fixedDeductionAmount ?? 0).toLocaleString(getCurrencyLocale())} salary deduction`}
                                </strong>{' '}
