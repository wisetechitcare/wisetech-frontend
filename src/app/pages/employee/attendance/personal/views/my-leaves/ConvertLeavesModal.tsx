                            ...
                            <div style={{ flex: 1 }}>
                                <div style={{
                                    ...
                                    <strong>Important:</strong> {selectedOption === 'encash' ? (
                                        <>
                                            Once submitted, <strong>{getTotalEncashLeaves()} {getTotalEncashLeaves() === 1 ? 'leave' : 'leaves'}</strong> will be deducted from your available balance. You will receive <strong>{currencyPrefix()}{transferableAmount.toLocaleString()}</strong> for these leaves after admin approval. If rejected or revoked, the leaves will be restored to your balance.
                                        </>
                                    ) : (
                                        <>
