  ...
  const menu = useMemo(() => {
    const items: NavigationItem[] = [
      ...
      },
      {
        ...
        // Strict: no permission grant means Projects is fully hidden, even for
        // an employee staffed on a specific project — an explicit grant is
        // required no matter what.
        visible: !isSectionBlocked('projects') && canViewModule('projects'),
      },
      {
        type: 'item',
        id: 'projects-tasks',
        ...
        visible: !isSectionBlocked('tasks') && canViewModule('tasks'),
      },
      {
        type: 'sub',
